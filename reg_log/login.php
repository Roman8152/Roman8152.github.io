...
if (isset($_SESSION["username"]) && isset($_SESSION["password"])) {
    header("location: ../mainStuff/corePage.php");
    exit;
}
else {
...
<html>
    <head>
        <title>Log in</title>
        <link rel="stylesheet" type="text/css" href="../additional_code/styles/style.css">
    </head>
    <body>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <br>
            <div id="rmmbr">
                <label><input type="checkbox" name="remember_me" id="rmmbr_me">Remember me<label>
            </div>
